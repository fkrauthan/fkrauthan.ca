...
function MenuLink({ route, title }) {
  return (
    <Link
      href={route}
      className="block sm:inline text-gray-800 dark:text-gray-300 dark:hover:text-yellow-400 font-bold hover:text-yellow-600 text-lg sm:text-center w-full no-underline sm:w-auto sm:pr-4 py-2 sm:py-1">
      {title}
    </Link>
  );
}
